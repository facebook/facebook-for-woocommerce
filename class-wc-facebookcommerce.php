...
class WC_Facebookcommerce extends WooCommerce\Facebook\Framework\Plugin {
	...
	public function clear_rollout_switch_transient() {
		wc_get_logger()->info('Cleared Whatsapp WooCommerce Rollout Transients',  array( 'source' => 'facebook-for-woocommerce' ) );
		delete_transient( '_wc_facebook_for_woocommerce_rollout_switch_flag' );
	}
