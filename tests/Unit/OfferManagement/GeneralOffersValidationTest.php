...
class GeneralOffersValidationTest extends OfferManagementAPITestBase {
	...
	public function test_offer_management_disabled(): void {
		...
		$this->validate_create_get_delete( $expected_error_data );
	}
	...
	public function validate_create_get_delete(array $expected_error_data): void
	{
