...
class ApiTest extends WP_UnitTestCase {
	...
	public function test_get_product_facebook_ids_creates_get_ids_request() {
		...
		$should_use_filter_endpoint = false;
		$response = $this->api->get_product_facebook_ids( $facebook_product_catalog_id, $facebook_product_retailer_id, $should_use_filter_endpoint );
	...
	public function test_get_product_facebook_ids_creates_get_ids_request_with_filter_endpoint() {
		...
		$should_use_filter_endpoint = true;
		$response = $this->api->get_product_facebook_ids( $facebook_product_catalog_id, $facebook_product_retailer_id, $should_use_filter_endpoint );
