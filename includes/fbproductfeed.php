...
class WC_Facebook_Product_Feed {
	...
	public function get_product_feed_header_row() {
		...
		'external_variant_id, is_woo_all_products_sync,plugin_version' . PHP_EOL;
	}
	...
	private function prepare_product_for_feed( $woo_product, &$attribute_variants ) {
		...
		static::format_string_for_feed( static::get_value_from_product_data( $product_data, 'plugin_version' ) ) . PHP_EOL;
	}
