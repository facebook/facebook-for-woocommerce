...
class WC_Facebook_Product_Feed {
	...
	/** @var int the number of products that has default product count */
	private $has_default_product_count = 0;

	/** @var int the number of products that has no product count */
	private $no_default_product_count = 0;

	/**
	 * Generates the product catalog feed. This replaces any previously generated feed file.
	 */
	 ...
	 *
	 * @return bool
	 * @throws PluginException IF the feed file directory cannot be created or the feed file cannot be written.
	 */
	 ...
	 *
	 * @return void
	 * @throws PluginException IF the feed file cannot be renamed.
	 */
	...
	/**
	 * Gets the header row for the product feed file.
	 *
	 * @return string
	 */
	...
	/**
	 * Formats the additional image urls for the feed.
	 *
	 * @param array $product_image_urls
	 * @return string
	 */
	private static function format_additional_image_url( $product_image_urls ) {
		// Returns the top 10 additional image urls separated by a comma according to feed api rules
	...
	/**
	 * Formats the string for the feed.
	 *
	 * @param string $text
	 * @return string
	 */
	...
	/**
	 * Formats the price for the feed.
	 *
	 * @param int    $value
	...
	/**
	 * Formats the variant for the feed.
	 *
	 * @param string $product_field
	 * @param string $value
	 * @param array  $parent_attribute_values
	 * @param array  $variant_feed_column passed by reference
	 */
	...
	/**
	 * Logs progress in local log file and FB.
	 *
	 * @param string $msg
