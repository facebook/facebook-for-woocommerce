...
class CollectionPage {
	...
	public function modify_product_query( $query ) {
		...
		// phpcs:ignore WordPress.Security.NonceVerification.Recommended -- Public read-only endpoint, URL generated by Facebook
		$clicked_product_id_raw = sanitize_text_field( urldecode( wp_unslash( $_GET['clicked_product_id'] ?? '' ) ) );
		...
		// phpcs:ignore WordPress.Security.NonceVerification.Recommended -- Public read-only endpoint, URL generated by Facebook
		$shown_product_ids_raw = explode( ',', sanitize_text_field( urldecode( wp_unslash( $_GET['shown_product_ids'] ?? '' ) ) ) );
