		...
		wp_localize_script(
			...
			array(
				...
				'i18n'                            => array(
					...
					'confirm_sync_modified'         => esc_html__( 'This will query all recently updated/modified products. Use this to keep your product catalog up to date without a full resync.', 'facebook-for-woocommerce' ),
